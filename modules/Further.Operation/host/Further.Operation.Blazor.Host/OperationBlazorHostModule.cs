...
using Further.Operation.Blazor.WebAssembly;
...
namespace Further.Operation.Blazor.Host;
...
[DependsOn(
    ...
    typeof(OperationBlazorWebAssemblyModule)
)]
public class OperationBlazorHostModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new OperationHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("Operation");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<OperationBlazorHostModule>();
        });
    }
}
