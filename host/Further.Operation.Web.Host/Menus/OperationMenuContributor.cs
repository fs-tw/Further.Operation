...
namespace Further.Operation.Menus;

public class OperationWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public OperationWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        context.Menu.SetSubItemOrder(OperationMenus.Prefix, 1);
